...
Source0:        mainline-tracking-pre-prod-v6.17-rc3-linux-250910T070627Z.tar.gz
Source1:        config
...
%setup -q -n mainline-tracking-pre-prod-v6.17-rc3-linux-250910T070627Z
%autosetup -p1 -n mainline-tracking-pre-prod-v6.17-rc3-linux-250910T070627Z
# %patch 0 -p1
make mrproper
